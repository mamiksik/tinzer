...
//~autogen generic-get-set classes.sensor>currentClass
		...
		{ return get_attr_set("modes"); }

		// Num Values: read-only
		// Returns the number of `value<N>` attributes that will return a valid value
		// for the current mode.
		int num_values() const
		{ return get_attr_int("num_values"); }
...
//~autogen generic-get-set classes.motor>currentClass
		...
		{ return get_attr_int("count_per_rot"); }
		...
		{ return get_attr_string("encoder_polarity"); }
		...
		{ return get_attr_string("polarity"); }
		...
		{ return get_attr_int("hold_pid/Kp"); }
		...
		{ return get_attr_int("hold_pid/Ki"); }
		...
		{ return get_attr_int("hold_pid/Kd"); }
		...
		{ return get_attr_string("speed_regulation"); }
		...
		{ return get_attr_int("speed_pid/Kp"); }
		...
		{ return get_attr_int("speed_pid/Ki"); }
		...
		{ return get_attr_int("speed_pid/Kd"); }
		...
		{ return get_attr_set("stop_commands"); }
...
//~autogen motor_commands classes.motor>currentClass
		...
		// Run the motor until another command is sent.
		void run_forever()
		{ set_command("run-forever"); }

		// Run to an absolute position specified by `position_sp` and then
		// stop using the command specified in `stop_command`.
		void run_to_abs_pos()
		{ set_command("run-to-abs-pos"); }
...
//~autogen generic-get-set classes.servoMotor>currentClass
		...
		{ return get_attr_int("max_pulse_sp"); }
		...
		{ return get_attr_int("mid_pulse_sp"); }
		...
		{ return get_attr_int("min_pulse_sp"); }
...
//~autogen generic-get-set classes.led>currentClass
		...
		{ return get_attr_int("max_brightness"); }
		...
		{ return get_attr_from_set("trigger"); }
...
//~autogen generic-get-set classes.powerSupply>currentClass
		...
		{ return get_attr_int("voltage_min_design"); }
...
//~autogen
		...
		{ return measured_current() / 1000000.f; }

		float measured_volts() const
		{ return measured_voltage() / 1000000.f; }
